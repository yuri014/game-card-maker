            ...
            <div class="profile-content">
                <div class="profile-social">
                    <div class="profile-image">
                        <img src="@if($user->profile->profileImage()) {{ $user->profile->profileImage() }} @else {{ asset('image/placeholder.jpg') }} @endif" alt="User">
                    </div>
                    <!--  -->
